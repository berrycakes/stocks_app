class AdminsController < ApplicationController
  ...
  before_action :correct_admin, only: %i[edit update destroy]
  ...
  def correct_admin
    return if current_user.admin.id == params[:id].to_i
  ...
  def admin_params
    params.require(:admin).permit(:first_name, :last_name, :mobile_number)
  end
end
